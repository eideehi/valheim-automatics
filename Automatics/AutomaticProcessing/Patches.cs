...
namespace Automatics.AutomaticProcessing
{
    ...
    internal static class Patches
    {
        ...
        private static bool BeehiveIncreseLevelPrefix(Beehive __instance, ZNetView ___m_nview,
            int i)
        {
        ...
        private static void CookingStationUpdateCookingPostfix(CookingStation __instance,
            ZNetView ___m_nview)
        {
        ...
        private static void CraftingStationFixedUpdatePostfix(CraftingStation __instance,
            ZNetView ___m_nview)
        {
            AutomaticCraft.Run(__instance, ___m_nview);
        }
        ...
        private static void FireplaceUpdateFireplacePostfix(Fireplace __instance, Piece ___m_piece,
            ZNetView ___m_nview)
        {
