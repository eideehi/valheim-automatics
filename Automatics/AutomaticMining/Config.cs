...
namespace Automatics.AutomaticMining
{
    internal static class Config
    {
        ...
        private static ConfigEntry<bool> _automaticMiningEnabled;
        ...
        public static bool AutomaticMiningEnabled => _automaticMiningEnabled.Value;
        ...
        public static void Initialize()
        {
            ...
            _automaticMiningEnabled = Configuration.Bind("automatic_mining_enabled", true);
