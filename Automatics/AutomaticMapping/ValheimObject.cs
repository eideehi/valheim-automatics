...
namespace Automatics.AutomaticMapping
{
    public static class ValheimObject
    {
        ...
        public static bool GetSpawner(string name, out Spawner spawner)
        {
            return Spawners.TryGetValue(name, out spawner);
        }
        ...
        {
            return SpawnerNames.TryGetValue(spawner, out name);
        }

        public static bool GetOther(string name, out Other other)
        {
            return Others.TryGetValue(name, out other);
        }
        ...
        {
            return OtherNames.TryGetValue(other, out name);
        }
