...
-a, --allow_non_duplicate_pins Include non-duplicate pins in the deletion targets. **[Note] Improper use of this option may result in the deletion of all pins, including those added by the player.**
-h, --help::::                 Displays a help message and exits the command.

### give
Usage: give (OPTIONS...) [ITEM]
Add the item to the player's inventory.

OPTIONS:
-q, --quality=VALUE        Quality of item
-n, --stack-size=VALUE     Size of item stack
-h, --help                 Displays a help message and exits the command.
