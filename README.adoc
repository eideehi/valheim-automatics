...
:uri-ndesk-options: http://ndesk.org/Options
:uri-license: link:LICENSE
:uri-config: link:CONFIG.adoc
:uri-issues: https://github.com/eideehi/valheim-automatics/issues
:uri-custom_map_icons_example: link:/examples/custom-icon-pack/MyCustomIcons
:uri-custom_map_icons_zip: link:/examples/custom-icon-pack/MyCustomIcons.zip
...
** {uri-litjson}[LitJSON]
** {uri-ndesk-options}[NDesk.Options]
