...
| -a, --allow_non_duplicate_pins |  non-duplicate pins in the deletion targets. **[Note] Improper use of this option may result in the deletion of all pins, including those added by the player.**
| -h, --help                     | Displays a help message and exits the command.
|===
